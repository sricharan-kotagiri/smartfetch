 ...
 */
export const validateUserExists = async (user_id) => {
    try {
        ...
        if (!user) {
            const error = new Error('User not found in users table');
 ...
 */
export const createShopkeeper = async (data) => {
    try {
 ...
 */
export const getShopkeeperByUserId = async (user_id) => {
    try {
        const { data: shopkeeper, error } = await supabase
            .from('shopkeepers')
            .select('*')
 ...
 */
export const getShopkeeperById = async (id) => {
    try {
        const { data: shopkeeper, error } = await supabase
            .from('shopkeepers')
            .select('*')
 ...
 */
export const updateShopkeeper = async (user_id, data) => {
    try {
 ...
 */
export const searchShopkeepersByLocation = async (latitude, longitude, radiusKm = 5) => {
    try {
 ...
 */
export const deleteShopkeeper = async (user_id) => {
    try {
...
//# sourceMappingURL=shopkeeper.service.js.map