 ...
 * Log OTP sent event
 */
export const logOtpSent = async (phone) => {
    try {
 ...
 */
export const logOtpVerified = async (phone) => {
    try {
        const { error } = await supabase
            .from('otp_logs')
            .insert([
 ...
 */
export const logOtpFailed = async (phone, error_message) => {
    try {
        const { error } = await supabase
            .from('otp_logs')
            .insert([
 ...
 */
export const getOtpLogs = async (phone, limit = 50) => {
    try {
 ...
 * Get OTP statistics
 */
export const getOtpStats = async (hours = 24) => {
    try {
...
//# sourceMappingURL=otp-log.service.js.map